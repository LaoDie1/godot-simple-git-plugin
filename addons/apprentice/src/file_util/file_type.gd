...
## 获取文件名后缀类型
static func get_suffix_type(file_path: String):
	var type = file_path.get_extension().to_lower()
	if type in ["jpg", "jpeg", "png", "gif", "bmp", "tiff", "webp", "svg", "ico", "psd", "raw", "heif", "heic", "avif", "jp2", "j2k", "jpf", "jpx", "jpm", "mj2", "dds", "exr", "tga", "pbm", "pgm", "ppm", "pnm", "hdr", "xpm", "cr2", "nef", "arw", "orf", "rw2", "raf", "srf", "dng"]:
		return IMAGE
		...
		return VIDEO
	elif type in ["aac", "aif", "aiff", "amr", "ape", "au", "awb", "caf", "dct", "dss", "dvf", "flac", "gsm", "iklax", "ivs", "m4a", "m4b", "m4p", "mmf", "mp3", "mpc", "msv", "ogg", "oga", "opus", "ra", "ram", "raw", "rf64", "sln", "tta", "voc", "vox", "wav", "wma", "wv"]:
		return SOUND
	elif type in ["txt", "csv", "json", "xml", "yaml", "yml", "html", "htm", "css", "js", "ts", "php", "py", "java", "c", "cpp", "h", "hpp", "cs", "go", "rb", "sh", "bat", "ps1", "md", "markdown", "tex", "log", "ini", "cfg", "conf", "sql", "rtf", "odt", "doc", "docx", "pdf", "xls", "xlsx", "ppt", "pptx"]:
		return TEXT
	return ERROR
