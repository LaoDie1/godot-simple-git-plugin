...
##  包装属性 Get 方法
##[br]
##[br][code]get_callable[/code]  获取属性方法，这个方法没有参数
##[br][code]return[/code]  返回包装器
static func getter(get_callable: Callable) -> GetterWrapperObject:
...
##[br][code]return[/code]  返回包装器
static func setter(set_callable: Callable) -> SetterWrapperObject:
