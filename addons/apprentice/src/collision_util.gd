...
## 获取这个对象的碰撞形状节点
static func get_collisions(object: CollisionObject2D) -> Array[Object]:
	var list : Array[Object] = []
	for owner_id in object.get_shape_owners():
		var collision_object = object.shape_owner_get_owner(owner_id)
		list.append(collision_object)
	return list
